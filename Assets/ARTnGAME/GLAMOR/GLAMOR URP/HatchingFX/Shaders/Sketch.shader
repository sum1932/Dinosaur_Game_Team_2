Shader "GIBLION/Sketch"
{
  ...
  TEXTURE2D(_ScreenSpaceShadowmapTexture);
            ...
            float4 frag (Varyings i) : SV_Target
            {
				...
				{
					rotationMatrix = float2x2(_CrossHatchingRotation.x, _CrossHatchingRotation.y, _CrossHatchingRotation.z, 1);//float2x2(1, 0, 0, 1);
				...
				float shadows = 1.0f - SAMPLE_TEXTURE2D(_ScreenSpaceShadowmapTexture, sampler_LinearClamp, i.texcoord).r;
