namespace Artngame.GLAMOR.Sketch // DanielIlett.Sketch
{
    ...
    public class SketchEditor : VolumeComponentEditor
    {
        ...
        SerializedDataParameter crossHatchingRotation;
        ...
        public override void OnEnable()
        {
            ...
            crossHatchingRotation = Unpack(o.Find(x => x.crossHatchingRotation));
        ...
        public override void OnInspectorGUI()
        {
            ...
            PropertyField(crossHatchingRotation);
