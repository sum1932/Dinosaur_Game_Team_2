namespace Artngame.GLAMOR.Sketch
{
    ...
    [System.Serializable, VolumeComponentMenu("GIBLION/Sketch")]
    public class SketchSettings : VolumeComponent, IPostProcessComponent
    {
        ...
        [Tooltip("Rotate hatch.")]
        public Vector3Parameter crossHatchingRotation = new Vector3Parameter(new Vector3(1.0f, 0.0f, 0.0f));
