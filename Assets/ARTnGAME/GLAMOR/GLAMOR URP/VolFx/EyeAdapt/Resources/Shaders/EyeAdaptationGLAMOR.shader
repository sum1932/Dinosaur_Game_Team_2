Shader "Hidden/Post FX/Eye Adaptation GLAMOR"
{
    Properties
    {
    ...
    CGINCLUDE
        ...
        float4 FragAdaptProgressive(VaryingsDefault i) : SV_Target
        {
            ...
            float prevExposure = tex2D(_MainTexB, (0.5).xx);
            exposure = InterpolateExposure(exposure, prevExposure);

            //return float4(0,0.1, 0, 1);// tex2D(_MainTex, i.uv) * 0.1;
            //return float4(0, 1, 0, 1);// tex2D(_MainTex, i.uv) * 0.1;
...
#include "Common.cginc"
            ...
            //#pragma multi_compile_local _EyeAdapt_ONLY _

            sampler2D    _MainTexA;
            sampler2D    _EyeAdaptTex;
            ...
            {   
                ...
                //half4 col = tex2D(_EyeAdaptTex, i.uv);
                //return col*2;// half4(0, 0, i.uv.x, 0)* col;

                half4 MainT = tex2D(_MainTexA, i.uv) * 1;
                half4 EyeAdapt = tex2D(_EyeAdaptTex, i.uv) * 1;
                return MainT * EyeAdapt.x;

//#ifdef _EyeAdapt_ONLY
//                return EyeAdapt * 1;
//#endif
                //return col + EyeAdapt * 1;
                //return half4(col.rgb + EyeAdapt.rgb, col.a);
            }
